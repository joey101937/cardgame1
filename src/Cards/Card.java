...
public abstract class Card implements Comparable{
    ...
    public static ArrayList<Card> getCardList(){
        ...
        output.add(new SandWormCard());
        output.add(new HellFiendCard());
        output.add(new DemonCard());
        ...
        output.add(new DarkClericCard());
        output.add(new InfectCard());
        ...
        output.add(new FaerieDragonCard());
        output.add(new RedHatchlingCard());
